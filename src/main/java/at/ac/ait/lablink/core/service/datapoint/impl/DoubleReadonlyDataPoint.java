 ...
 */
public class DoubleReadonlyDataPoint extends DataPointGeneric<Double> 
    implements IDataPoint<Double> {
  /**
   * Constructor.
   *
   ...
   */
  public DoubleReadonlyDataPoint(List<String> identifier, String name, String unit) {
    super(identifier, name, unit, false, new DoubleValue());
  }
