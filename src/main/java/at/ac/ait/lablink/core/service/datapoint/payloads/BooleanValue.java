 ...
 */
public class BooleanValue extends BaseValue implements ISimpleValue<Boolean> {
   ...
   */
  public BooleanValue(boolean value, long time) {
    super(time);
    this.value = value;
  }
  ...
  public void encode(final IEncoder encoder) {
    ...
    encoder.putBoolean("value", value);
  }

  @Override
  public void decode(final IDecoder decoder) {
    super.decode(decoder);
    value = decoder.getBoolean("value");
  }

  @Override
  public String getType() {
    return BooleanValue.getClassType();
  }
  ...
  public String toString() {
    return "BooleanValue{" + "value=" + value + ", " + super.toString() + '}';
  }
